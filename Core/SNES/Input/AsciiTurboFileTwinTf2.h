...
public:
	...
	void Init() override
	{
		...
		_emu->GetBatteryManager()->LoadBattery("SNES", ".turbofile.sav", _data, AsciiTurboFileTwinTf2::FileSize);
	}

	void SaveBattery() override
	{
		_emu->GetBatteryManager()->SaveBattery("SNES", ".turbofile.sav", _data, AsciiTurboFileTwinTf2::FileSize);
	}
