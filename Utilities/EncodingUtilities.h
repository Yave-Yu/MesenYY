...
namespace EncodingUtilities
{
	...
	//Returns false as soon as an invalid/overlong/surrogate/out-of-range sequence is encountered
	...
	//Converts a CP936/GBK-encoded string to UTF-8
	//Falls back to the original string if the conversion is unavailable for any reason
	...
	//Strings that are already valid UTF-8 (this includes plain ASCII) are returned unchanged
	//Everything else is assumed to be GBK/CP936 and re-encoded
