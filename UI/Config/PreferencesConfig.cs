...
namespace Mesen.Config
{
	public partial class PreferencesConfig : BaseConfig<PreferencesConfig>
	{
		...
		[ObservableProperty] public partial bool KeepSize { get; set; } = true;
		[ObservableProperty] public partial double CurrentSize { get; set; } = 3;
		...
		[ObservableProperty] public partial UInt32 HudCustomSize { get; set; } = 2;
		...
		[ObservableProperty] public partial FontConfig MesenFont { get; set; } = new FontConfig() { FontFamily = "Segoe UI", FontSize = 12 };
