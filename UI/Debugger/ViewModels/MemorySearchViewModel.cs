...
public partial class MemorySearchViewModel : DisposableViewModel
{
	...
	[ObservableProperty] public partial MemorySearchFormat Format { get; set; } = MemorySearchFormat.Unsigned;
	[ObservableProperty] public partial MemorySearchValueSize ValueSize { get; set; } = MemorySearchValueSize.Byte;

	[ObservableProperty] public partial MemorySearchCompareTo CompareTo { get; set; } = MemorySearchCompareTo.LastValue;
